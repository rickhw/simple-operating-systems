同樣會出現 reboot loop, 底下是 core dump.

我只有修改 task.c 的 sys_exec, create_user_task
...
Added to ISO image: directory '/'='/tmp/grub.GeHIZi'
...
10+0 records in
10+0 records out
10485760 bytes transferred in 0.001769 secs (5927507066 bytes/sec)
...
Created a new DOS (MBR) disklabel with disk identifier 0xde8a3b91.

Command (m for help): Created a new DOS (MBR) disklabel with disk identifier 0xecce80c0.
...
Servicing hardware INT=0x08
     0: v=80 e=0000 i=1 cpl=3 IP=001b:08048062 pc=08048062 SP=0023:083ffebc env->regs[R_EAX]=00000002
...
check_exception old: 0xe new 0xd
     4: v=08 e=0000 i=0 cpl=3 IP=001b:080481a9 pc=080481a9 SP=0023:083ffecc env->regs[R_EAX]=00000002
EAX=00000002 EBX=00000000 ECX=00000023 EDX=08049054
ESI=00000000 EDI=00000000 EBP=083ffffc ESP=083ffecc
EIP=080481a9 EFL=00000206 [-----P-] CPL=3 II=0 A20=1 SMM=0 HLT=0
ES =0023 00000000 ffffffff 00cff300 DPL=3 DS   [-WA]
