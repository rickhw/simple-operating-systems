完全替換 switch_task.S 和 task.c 之後，重跑狀況一樣
...
lib/task.c:79:33: warning: passing argument 2 of 'switch_task' discards 'volatile' qualifier from pointer target type [-Wdiscarded-qualifiers]
   79 |         switch_task(&prev->esp, &current_task->esp);
      |                                 ^~~~~~~~~~~~~~~~~~
...
lib/task.c:129:34: warning: initialization of 'uint32_t' {aka 'unsigned int'} from 'void *' makes integer from pointer without a cast [-Wint-conversion]
  129 |     uint32_t child_ustack_phys = pmm_alloc_page();
      |                                  ^~~~~~~~~~~~~~
...
Added to ISO image: directory '/'='/tmp/grub.dgU2mh'
...
10+0 records in
10+0 records out
10485760 bytes transferred in 0.001983 secs (5287826525 bytes/sec)
...
Created a new DOS (MBR) disklabel with disk identifier 0x382d942d.

Command (m for help): Created a new DOS (MBR) disklabel with disk identifier 0xf5b78c95.
...
Servicing hardware INT=0x20
     0: v=20 e=0000 i=0 cpl=0 IP=0008:00100189 pc=00100189 SP=0010:00109f88 env->regs[R_EAX]=00000058
EAX=00000058 EBX=00105084 ECX=000001f7 EDX=000001f7
ESI=00000000 EDI=001100a0 EBP=00000000 ESP=00109f88
EIP=00100189 EFL=00000282 [--S----] CPL=0 II=0 A20=1 SMM=0 HLT=0
ES =0010 00000000 ffffffff 00cf9300 DPL=0 DS   [-WA]
...
Servicing hardware INT=0x21
     1: v=21 e=0000 i=0 cpl=0 IP=0008:00101790 pc=00101790 SP=0010:00109fc8 env->regs[R_EAX]=c0000030
...
EFER=0000000000000000
Servicing hardware INT=0x20
     2: v=20 e=0000 i=0 cpl=0 IP=0008:00101790 pc=00101790 SP=0010:00109fc8 env->regs[R_EAX]=c0000030
EAX=c0000030 EBX=c000000c ECX=00000000 EDX=c0000030
ESI=c000000c EDI=00105084 EBP=00000000 ESP=00109fc8
EIP=00101790 EFL=00000297 [--S-APC] CPL=0 II=0 A20=1 SMM=0 HLT=0
ES =0010 00000000 ffffffff 00cf9300 DPL=0 DS   [-WA]
