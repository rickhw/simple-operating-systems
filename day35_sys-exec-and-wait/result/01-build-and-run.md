...
lib/task.c:89:33: warning: passing argument 2 of 'switch_task' discards 'volatile' qualifier from pointer target type [-Wdiscarded-qualifiers]
   89 |         switch_task(&prev->esp, &current_task->esp);
      |                                 ^~~~~~~~~~~~~~~~~~
...
lib/task.c:103:34: warning: initialization of 'uint32_t' {aka 'unsigned int'} from 'void *' makes integer from pointer without a cast [-Wint-conversion]
  103 |     uint32_t child_ustack_phys = pmm_alloc_page();
      |                                  ^~~~~~~~~~~~~~
...
lib/tty.c: In function 'terminal_initialize':
lib/tty.c:25:13: warning: implicit declaration of function 'terminal_putentryat' [-Wimplicit-function-declaration]
   25 |             terminal_putentryat(' ', terminal_color, x, y);
      |             ^~~~~~~~~~~~~~~~~~~
lib/tty.c:28:5: warning: implicit declaration of function 'update_cursor' [-Wimplicit-function-declaration]
   28 |     update_cursor(terminal_column, terminal_row);
      |     ^~~~~~~~~~~~~
lib/tty.c: In function 'terminal_putchar':
lib/tty.c:44:9: warning: implicit declaration of function 'terminal_scroll' [-Wimplicit-function-declaration]
   44 |         terminal_scroll();
      |         ^~~~~~~~~~~~~~~
lib/tty.c: At top level:
lib/tty.c:59:6: warning: conflicting types for 'terminal_putentryat'
   59 | void terminal_putentryat(char c, uint8_t color, size_t x, size_t y) {
      |      ^~~~~~~~~~~~~~~~~~~
lib/tty.c:25:13: note: previous implicit declaration of 'terminal_putentryat' was here
   25 |             terminal_putentryat(' ', terminal_color, x, y);
      |             ^~~~~~~~~~~~~~~~~~~
lib/tty.c:64:6: warning: conflicting types for 'terminal_scroll'
   64 | void terminal_scroll() {
      |      ^~~~~~~~~~~~~~~
lib/tty.c:44:9: note: previous implicit declaration of 'terminal_scroll' was here
   44 |         terminal_scroll();
      |         ^~~~~~~~~~~~~~~
lib/tty.c:78:6: warning: conflicting types for 'update_cursor'
   78 | void update_cursor(int x, int y) {
      |      ^~~~~~~~~~~~~
lib/tty.c:28:5: note: previous implicit declaration of 'update_cursor' was here
   28 |     update_cursor(terminal_column, terminal_row);
      |     ^~~~~~~~~~~~~
...
Media summary: 0 sessions, 0 data blocks, 0 data,  270g free
Added to ISO image: directory '/'='/tmp/grub.QPpbWi'
...
Media status : is blank
Media summary: 0 sessions, 0 data blocks, 0 data,  270g free
Added to ISO image: directory '/'='/tmp/grub.1feDFi'
xorriso : UPDATE :     335 files added in 1 seconds
Added to ISO image: directory '/'='/workspace/isodir'
xorriso : UPDATE :     340 files added in 1 seconds
xorriso : NOTE : Copying to System Area: 512 bytes from file '/usr/lib/grub/i386-pc/boot_hybrid.img'
...
10+0 records in
10+0 records out
10485760 bytes transferred in 0.001953 secs (5369052739 bytes/sec)
...
Created a new DOS (MBR) disklabel with disk identifier 0xb9d6bfca.

Command (m for help): Created a new DOS (MBR) disklabel with disk identifier 0x73f4bccf.
...
Added to ISO image: directory '/'='/tmp/grub.TrnB4e'
xorriso : UPDATE :     335 files added in 1 seconds
Added to ISO image: directory '/'='/workspace/isodir'
xorriso : UPDATE :     340 files added in 1 seconds
xorriso : NOTE : Copying to System Area: 512 bytes from file '/usr/lib/grub/i386-pc/boot_hybrid.img'
