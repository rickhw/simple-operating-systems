跑起來後，突然就 hang 著不動了，底下是 core dump and 相關 source code.

```bash
   337: v=80 e=0000 i=1 cpl=3 IP=001b:08049202 pc=08049202 SP=0023:083ffcfc env->regs[R_EAX]=00000005
EAX=00000005 EBX=00000000 ECX=00000000 EDX=00000000
ESI=00000000 EDI=00000000 EBP=083ffd18 ESP=083ffcfc
EIP=08049202 EFL=00000206 [-----P-] CPL=3 II=0 A20=1 SMM=0 HLT=0
...
Servicing hardware INT=0x20
   338: v=20 e=0000 i=0 cpl=0 IP=0008:00107cb8 pc=00107cb8 SP=0010:c0007a20 env->regs[R_EAX]=c000017c
EAX=c000017c EBX=0010e1b8 ECX=0010e1e0 EDX=c00000bc
ESI=c000017c EDI=002ef724 EBP=083ffd18 ESP=c0007a20
EIP=00107cb8 EFL=00000297 [--S-APC] CPL=0 II=0 A20=1 SMM=0 HLT=0
ES =0023 00000000 ffffffff 00cff300 DPL=3 DS   [-WA]
...
DR0=00000000 DR1=00000000 DR2=00000000 DR3=00000000
DR6=ffff0ff0 DR7=00000400
CCS=00000095 CCD=fffffffc CCO=EFLAGS
EFER=0000000000000000
```
