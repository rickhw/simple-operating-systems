...
docker run --rm -v /Users/rickhwang/Repos/ai-lab/simple-operating-systems/day08/src.macos:/workspace -w /workspace os-builder grub-mkrescue -o myos.iso isodir
WARNING: The requested image's platform (linux/amd64) does not match the detected host platform (linux/arm64/v8) and no specific platform was requested
...
Added to ISO image: directory '/'='/tmp/grub.BRQjfh'
